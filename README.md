...
| `yarn rewards:backfill` | Recover delegate reward history from on-chain events. Dry run by default; `--apply` to scan and write. See [operations §5.7](./docs/operations.md). |
